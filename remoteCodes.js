//Used seperate IR receiver to receive these codes
//Commands for power
var power = {
...
//Uses built in IR blaster
// Puck.wrtie is built into Puck.js library. Writes code to Puck.js console to send bits of data at one time
function shootIR(array){
	Puck.write('LED1.set();\n') //These two LED lines just turn the light on and off when you press a button
	Puck.write('LED1.reset();\n') //To see it work in person
	Puck.write('Puck.IR(['+array+']);\n') //Sends the Puck.IR command to console with the chosen IR array to execute the command
}